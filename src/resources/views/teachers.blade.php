@include('header')
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Hola señor administrador, aqui puedes registrar, borrar o actualizar los datos de los docentes de la institucion <a target="_self" href="#">UNIADMIN</a>.</p>
...
@include('footer')
<script src="/assets/js/demo/datatables-teachers.js"></script>
